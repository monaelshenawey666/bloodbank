        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="mx-auto order-0 navbar-brand mx-auto">
                    <a href="https://www.instagram.com/ipda3.tech/"><i class="fab fa-instagram github">&nbsp;&nbsp;</i></a>
                    <a href="{{$settings->fb_link}}" target="_blank"><i class="fab fa-facebook-f facebook">&nbsp;&nbsp;</i></a>
                    <a href="{{$settings->twiter_link}}"><i class="fab fa-twitter twitter">&nbsp;&nbsp;</i></a>
                    <a href="https://api.whatsapp.com/send?phone=+201097571186"><i class="fab fa-whatsapp whats">&nbsp;&nbsp;</i></a>
                </div>
    ...
    <section id="Nav2">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                @php //dd(auth()->guard('client-web')->user()); @endphp
                @if(auth()->guard('client-web')->check())
                <button class="btn login" onclick= "window.location.href = '{{url('client-logout')}}';">logout</button>
                @else
